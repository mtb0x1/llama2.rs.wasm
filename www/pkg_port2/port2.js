...
/**
* @param {Uint8Array} model_buffer
* @param {Uint8Array} tokenizer_buffer
* @param {number} temperature
* @param {number} steps
* @param {string} prompt
* @returns {string}
*/
export function main_wasm(model_buffer, tokenizer_buffer, temperature, steps, prompt) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(model_buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(tokenizer_buffer, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.main_wasm(retptr, ptr0, len0, ptr1, len1, temperature, steps, ptr2, len2);
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('port2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
