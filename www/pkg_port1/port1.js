...
*/
export function main_wasm(model_buffer, tokenizer_buffer, temperature, seq_len) {
    ...
    wasm.main_wasm(ptr0, len0, ptr1, len1, temperature, seq_len);
}
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('port1_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
